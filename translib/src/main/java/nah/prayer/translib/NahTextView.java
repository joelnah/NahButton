...
public class NahTextView extends AppCompatTextView implements DrawableEnriched {
    ...
    public NahTextView(Context context) {
        super(context);
        init(context, null, 0);
    }

    public NahTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
        getAttrs(attrs);
    }

    public NahTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNahDrawableHelper = new NahDrawableHelper(context, attrs, defStyleAttr, 0);
