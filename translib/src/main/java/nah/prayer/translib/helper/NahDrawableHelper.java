package nah.prayer.translib.helper;
...
import nah.prayer.translib.R;


public class NahDrawableHelper implements DrawableEnriched {
    ...
    public NahDrawableHelper(@NonNull Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        mContext = context;

        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.TextViewNahDrawable, defStyleAttr, defStyleRes);

        try {
            mDrawableWidth = array.getDimensionPixelSize(R.styleable.TextViewNahDrawable_drawableWidth, UNDEFINED);
            mDrawableHeight = array.getDimensionPixelSize(R.styleable.TextViewNahDrawable_drawableHeight, UNDEFINED);
            mDrawableStartVectorId = array.getResourceId(R.styleable.TextViewNahDrawable_drawableStartVector, UNDEFINED);
            mDrawableTopVectorId = array.getResourceId(R.styleable.TextViewNahDrawable_drawableTopVector, UNDEFINED);
            mDrawableEndVectorId = array.getResourceId(R.styleable.TextViewNahDrawable_drawableEndVector, UNDEFINED);
            mDrawableBottomVectorId = array.getResourceId(R.styleable.TextViewNahDrawable_drawableBottomVector, UNDEFINED);
            mDrawableTint = array.getColor(R.styleable.TextViewNahDrawable_drawableTint, UNDEFINED);
        } finally {
            array.recycle();
        }
    }
